var baseVersion='V1.0';				//基础版本
var version = '';					//版本号，默认按V2.1.3.2格式
//输出目录
var outputFolder = 'D:media/{version}';

//只复制不压缩的文件，以,分隔
var srcFolder='media';
var copyFiles = 'js/config.js,*.doc,data/*.*,data/images/*.*';
var md5File = 'MD5.txt';
var zipFile = 'media.zip';
...
if(!version){
	...
	version=baseVersion+'.'+(now.getMonth()+1)+'.'+(now.getDate())+'.'+version;
}
